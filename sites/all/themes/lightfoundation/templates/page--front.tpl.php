	...
	<div id="wrapper">
			...
			<div class="holder960 clearfix">
				...
				<div class="aboutIntro">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
						 ...
						 commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit Ut enim ad minim veniam.</p>
				
				
					<!--Icons background-->
					<div class="icoBg">
						<img src="sites/all/themes/lightfoundation/images/icons.png" alt="">
		...
		<section id="services" class="clearfix section">
			...
			<div class="holder960 clearfix">
				...
				Duis aute irure dolor in reprehenderit in voluptate velit Ut enim ad minim veniam.
					</p>
				</div>
				<!--End intro-->
					...
					<div id="testimonials">
						...
						<div class="testimoniaContainer">
							...
							<div class="testi">
								...
								<h3>John Doe &ndash; <span>Interactive designer</span></h3>
						</div><!--End testi-->

						<!--Testi-->
						<div class="testi">
							<blockquote>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip. </blockquote>
							<h3>Jenny Doe &ndash; <span>Motion designer</span></h3>									
						</div><!--End testi-->
